...
public class Ferrell_ProblemSentimentAnalysis {
    ...
    public static ReviewEntry[] parseFile() throws IOException {
        ...
        //On my computer i've put the .tsv file in my src folder instead of the root folder.
        //I've added some try catch statements so that it will work in the root folder as well.
        try {
        ...
        for (int i = 1; i < list.size(); i++) {
            //This is the list of review entries i've found do not exist.
